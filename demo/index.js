	  ...
	  _createClass(InlineEdit, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.isDisabled) {
	        ...
	        return _react2.default.createElement('div', { className: 'inline-edit ' + (this.props.className ? 'inline-edit-' + this.props.className : '') }, _react2.default.createElement(Element, { className: this.props.className,
	          style: this.props.style }, this.state.text || this.props.placeholder), EditBtn);
	      } else if (!this.state.editing) {
	        var _Element = this.props.element || this.props.staticElement;
	        return _react2.default.createElement('div', { className: 'inline-edit ' + (this.props.className ? 'inline-edit-' + this.props.className : '') }, _react2.default.createElement(_Element, { className: this.props.className,
	          onClick: this.startEditing,
	          tabIndex: this.props.tabIndex,
	          style: this.props.style,
	          ref: 'inlineText' }, this.state.text || this.props.placeholder), EditBtn);
	      } else {
	        ...
	        return _react2.default.createElement('div', { className: 'inline-edit ' + (this.props.activeClassName ? this.props.activeClassName : 'editing') + ' ' + (this.props.className ? 'inline-edit-' + this.props.className : ''),
	          style: setInlineEditWidth }, _react2.default.createElement(GhostElem, { className: this.props.className + ' ' + (isTextArea ? 'ghost-textarea' : ''),
	          ...
	          inputDimensions: { width: this.state.inputWidth, height: this.state.inputHeight } }), _react2.default.createElement(_Element2, { className: (this.props.className ? this.props.className : '') + ' ' + this.props.staticElement,
	...
	var GhostElem = function (_React$Component2) {
	  ...
	  _createClass(GhostElem, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(StaticElem, { className: this.props.className + ' measure-length ghost-elem',
	        style: _extends({}, this.props.style, getWidth),
	        ref: 'measureDimensions' }, this.state.text);
	    }
	  }]);
